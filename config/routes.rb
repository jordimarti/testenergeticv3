Rails.application.routes.draw do
  ...
  resources :murs
  resources :entitats
  get 'entitats/:id/transmitancies', to: 'entitats#transmitancies', as: 'entitat_transmitancies'
  ...
  get 'home/index'
  get 'home/contacta'
  get 'home/tutorials', to: 'home#tutorials', as: 'tutorials'
  get 'home/recursos', to: 'home#recursos', as: 'recursos'
  root :to => "home#index"
end
