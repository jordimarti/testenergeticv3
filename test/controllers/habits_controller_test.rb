...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { ambit: @habit.ambit, descripcio: @habit.descripcio, entitat_id: @habit.entitat_id, nom: @habit.nom } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { ambit: @habit.ambit, descripcio: @habit.descripcio, entitat_id: @habit.entitat_id, nom: @habit.nom } }
